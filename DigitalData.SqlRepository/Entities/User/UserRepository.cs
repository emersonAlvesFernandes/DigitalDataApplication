    ...
    public class UserRepository : RepositoryBase, IUserRepository
    {
        ...
        public UserEntity GetByEmail(string userEmail)
        {
            try
            {
                ...
                using (var cmd = new SqlCommand("spr_ler_usuario_por_email", connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@des_email", userEmail.ToLower().Trim());
        ...
        public UserEntity Update(UserEntity user)
        {
            ...
            try
            {
                using (var cmd = new SqlCommand("spr_upd_usuar", connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
